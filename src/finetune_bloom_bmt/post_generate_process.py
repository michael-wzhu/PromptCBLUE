...
if __name__ == "__main__":
    pred_test_file = "medical_prompts/datasets/PromptCBLUE/open_version_v0.1/dev.json"
    ...
    json.dump(
        structured_outputs,
        open("medical_prompts/datasets/PromptCBLUE/open_version_v0.1/dev_structured.json", "w", encoding="utf-8"),
        ensure_ascii=False,
        indent=2
    )
