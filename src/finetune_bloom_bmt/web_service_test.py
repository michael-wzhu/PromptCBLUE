...
def test_service(input_text):
    ...
    request = urllib.request.Request(
        url='http://127.0.0.1:9001/instruct_generate',
        headers=header,
...
if __name__ == "__main__":
    ...
    with open("medical_prompts/datasets/prompt_datasets/multitask/dev.json", "r", encoding="utf-8") as f:
